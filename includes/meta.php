...
?>
    ...
    <div class="para-settings resumes-builder-settings">
        <div class="option-box">
			...
			<textarea cols="50" rows="1" style="background:#bfefff" onClick="this.select();" >[wp_rb <?php echo ' id="'.$post->ID.'"';?> ]</textarea>
        <br /><br />
        PHP Code:<br />
        <textarea cols="50" rows="1" style="background:#bfefff" onClick="this.select();" ><?php echo '<?php echo do_shortcode("[wp_rb id='; echo "'".$post->ID."' ]"; echo '"); ?>'; ?></textarea>  
		</div>
