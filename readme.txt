...
please see the screenshot for understand filter map 
...
Please see the sample addown inside plugin folder <b>"demo-addon" (wp-resume-builder-addon-themes.zip)</b> you can install as plugin and ready to customize.
